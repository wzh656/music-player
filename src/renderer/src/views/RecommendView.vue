...
function playMusic() {
  ...
  currentLyrics.value = null; //设为当前歌词
...
<template>
  ...
  <div class="recommend-buttons">
    <button class="hot" @click="hotRecommend">热歌推荐</button>
    <button class="new" @click="newRecommend">新歌推荐</button>
    <button class="rising" @click="risingRecommend">飙升推荐</button>
    <button class="original" @click="originalRecommend">原创推荐</button>
  </div>
  <div v-if="songPicUrl" class="songCard">
    <img
      :src="songPicUrl"
      :disabled="vipSong"
      tabindex="0"
    ...
    <div class="info">
      ...
      <div class="buttons">
        <button :disabled="vipSong" @click.stop="download">下载</button>
